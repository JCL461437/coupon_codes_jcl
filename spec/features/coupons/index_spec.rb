...
describe "merchant coupons index" do
  before :each do
    ...
    @coupon3 = Coupon.create!(name: "No Way Twenty Dollars Off!", unique_code: "12ASFSSFJ6", dollar_off: 2000, percent_off: 0, merchant: @merchant2 )
    @coupon4 = Coupon.create!(name: "Five Dollars Off!", unique_code: "GHKFHDSD82", dollar_off: 500, percent_off: 0, merchant: @merchant1 )
    @coupon5 = Coupon.create!(name: "Five Percent Off!", unique_code: "W712FG3FJ6", dollar_off: 0, percent_off: 0.05, merchant: @merchant1 )
    @coupon6 = Coupon.create!(name: "Twenty Dollars Off!", unique_code: "ASSSFSSFJ6", dollar_off: 2000, percent_off: 0, merchant: @merchant1 )
    
    @coupon7 = Coupon.create!(name: "Five Percent Off What!!", unique_code: "SKLGSKD4", dollar_off: 0, percent_off: 0.05, status: 0, merchant: @merchant1 )
    ...
    @coupon10 = Coupon.create!(name: "Thirty Dollars Off!", unique_code: "FS56SFJ6", dollar_off: 3000, percent_off: 0, status: 0, merchant: @merchant1 )
  end
  ...
  it "can see a link to merchant coupons index page that will bring me to merchant_coupons_path" do
    ...
    expect(page).to have_content("Dollar off $#{@coupon2.dollar_off*0.01}")
  ...
  it "sorts the coupons between active and inactive coupons" do
    ...
    within "#activated" do
      ...
      expect(page).to have_content("Dollar off $#{@coupon5.dollar_off*0.01}")
      expect(page).to have_content("Percent off #{@coupon5.percent_off*10} %")
      expect(page).to have_content("#{@coupon6.name}")
      expect(page).to have_content("Dollar off $#{@coupon6.dollar_off*0.01}")
      expect(page).to have_content("Percent off #{@coupon6.percent_off*10} %")
    ...
    within "#deactivated" do
      ...
      expect(page).to have_content("Dollar off $#{@coupon7.dollar_off*0.01}")
      expect(page).to have_content("Percent off #{@coupon7.percent_off*10} %")
      expect(page).to have_content("#{@coupon8.name}")
      expect(page).to have_content("Dollar off $#{@coupon8.dollar_off*0.01}")
      expect(page).to have_content("Percent off #{@coupon8.percent_off*10} %")
      expect(page).to have_content("#{@coupon9.name}")
      expect(page).to have_content("Dollar off $#{@coupon9.dollar_off*0.01}")
      expect(page).to have_content("Percent off #{@coupon9.percent_off*10} %")
      expect(page).to have_content("#{@coupon10.name}")
      expect(page).to have_content("Dollar off $#{@coupon10.dollar_off*0.01}")
      expect(page).to have_content("Percent off #{@coupon10.percent_off*10} %")
      expect(page).to have_content("#{@coupon6.name}")
